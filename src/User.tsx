...
const Info = {
    name: "Kamaldeep",
    stack: ["Software Developer", "Full Stack Developer"],
...
const SkillInfo = [
    {
        title: "Frontend",
        skills: ["HTML", "CSS", "SASS", "JavaScript", "React JS", "Tailwind CSS", "Material UI", "Bootstrap"
        ]
    },
    {
        title: "Backend",
...
const ExperienceInfo = [
    {
        ...
        skills: ["Springboot", "React JS", "Node JS", "MySQL", "MongoDB", "Microservices"]
    },
    // {
